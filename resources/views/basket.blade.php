...
@section('content')
    ...
    <main class="flex flex-col gap-14 container mx-auto max-w-[1280px] px-4 py-10">
        ...
        <div class="flex flex-col gap-6 bg-white p-4 rounded-xl">
            ...
            <button
                class="w-full md:w-[260px] px-4 py-1 rounded-xl bg-[#885041] text-white transition-all duration-500 border border-[#885041] hover:text-[#885041] hover:bg-transparent text-center">Оформить
                заказ</button>
        </div>
    </main>
@endsection
