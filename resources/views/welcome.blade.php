...
@section('content')
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col w-full gap-4 FAQ">
            ...
            <p class="tracking-wider p-4 hidden answer">
                В оплату украшений, произведенных на заказ, принимаются только денежные средства. Баллы, купоны, программа
        ...
        <div class="flex flex-col w-full gap-4 FAQ">
            ...
            <p class="tracking-wider p-4 hidden answer">
                Мы покупаем драгоценные и полудрагоценные камни любых размеров и параметров по всему миру, в том числе и на
